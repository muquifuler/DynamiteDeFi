...
contract Padlock is Ownable{
    ...
    */
    ...
    function bet() payable external{
        ...
        users[msg.sender] = User(
            msg.value, 
            string(abi.encodePacked(abc[makeRandomnum(0)], abc[makeRandomnum(1)], abc[makeRandomnum(2)], abc[makeRandomnum(3)], abc[makeRandomnum(4)]))
        );
    ...
    */
    ...
    function migrateContract(address payable contrato) external onlyOwner {// It is used in case you need to migrate the funds to a new contract
